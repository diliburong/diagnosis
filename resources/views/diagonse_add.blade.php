	...
	<form action="" method="post" class="form form-horizontal" id="form-diagonse-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="0" placeholder="" name="diagonse_no"  datatype="*" nullmsg="序号不能为空">
			</div>
		</div>
		<div class="row cl">
...
<script>
		...
		submitHandler:function(form){
			$(form).ajaxSubmit({
				type:'post',
				url:'/admin/service/diagonse/add',
				dataType:'json',
				data:{
					patientId:$('input[name=name]').val(),
					diagonse_no:$('input[name=diagonse_no]').val(),
